...
public class DataProvider {
    ...
    private static List<Kelinci> initDataKelinci(Context ctx) {
        ...
        kelincis.add(new Kelinci("American rabbit", "Amerika",
                "adalah jenis kelinci diakui oleh amerika rabbit pada tahun 1917.", R.drawable.amerika_rabit));
        kelincis.add(new Kelinci("Holland lop", "Belanda",
                "adalah jenis kelinci domestik yg di akui oleh amerikan breeders asosiasi pada tahun 1979", R.drawable.hollad));
        kelincis.add(new Kelinci("sylvilagus cunicularius", "meksiko",
                "adalah spesies mamalia pada pamili leporidae spisies ini endemik terhadap meksiko.", R.drawable.sylvialagus));
        kelincis.add(new Kelinci("checkered giant", "Tiongkok",
                "adalah jenis kelinci domestik yg berasal dari prancis", R.drawable.checkered));
        kelincis.add(new Kelinci("brown chestnut of lorraine", "prancis",
                "adalah jenis kelinci domestik yg berasal dari prancis dan diberinama untuk wilayah lorranie", R.drawable.brown));
        kelincis.add(new Kelinci("Fee de Marbourg", "Jerman",
                "adalah jenis keinci yang berasasl dari jerman.", R.drawable.fee));
        return kelincis;
    }
